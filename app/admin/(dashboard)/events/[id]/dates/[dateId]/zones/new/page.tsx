...
export default async function AdminNewZonePage({ params }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-lg font-semibold text-white">New zone</h2>
      </div>
      <ZoneForm eventDateId={dateId} eventId={eventId} />
    </div>
  );
}
